        ...
        Swal.fire({
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input id="nome" placeholder="Digite o nome" class="form-control" value="${animal.nome}"/>
                </div>
                <div class="col-md-6">
                    <label for="raca" class="form-label labelInput">Raça: </label>
                    <input id="raca" placeholder="Digite a raça" class="form-control" value="${animal.raca}"/>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input id="data" type="date" class="form-control" max="${todayDate}" value="${animal.data}"/>
                </div>
                <div class="col-md-6">
                    <label for="cor" class="form-label labelInput">Cor: </label>
                    <input id="cor" placeholder="Digite a Cor" class="form-control" value="${animal.cor}"/>
                </div>
            </div>
